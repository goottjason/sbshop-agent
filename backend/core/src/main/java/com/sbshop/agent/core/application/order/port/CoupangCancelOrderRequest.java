...
public record CoupangCancelOrderRequest(
	...
	@JsonProperty("receiptCounts") List<Integer> receiptCounts,
	@JsonProperty("bigCancelCode") String bigCancelCode,
	@JsonProperty("middleCancelCode") String middleCancelCode,
